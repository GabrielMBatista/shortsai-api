...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        // Example URL: https://pub-xxx.r2.dev/scenes/videos/abc.mp4
        // Example URL from Storage: https://assets.shortsai.com/scenes/videos/abc.mp4
        // We need 'scenes/videos/abc.mp4'
        ...
        console.log(`[Proxy] Fetching from S3/R2: ${objectKey}`);
